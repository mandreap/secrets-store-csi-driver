...
import (
	...
	v1alpha1 "sigs.k8s.io/secrets-store-csi-driver/pkg/client/clientset/versioned/typed/apis/v1alpha1"
)

type FakeSecretsstoreV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeSecretsstoreV1alpha1) RESTClient() rest.Interface {
