...
import (
	...
	apis "sigs.k8s.io/secrets-store-csi-driver/pkg/client/informers/externalversions/apis"
...
type SharedInformerFactory interface {
	...
	Secretsstore() apis.Interface
}

func (f *sharedInformerFactory) Secretsstore() apis.Interface {
