...
func (in *CachePodSecrets) DeepCopyInto(out *CachePodSecrets) {
	*out = *in
	if in.CacheSecretFilesSpcMapping != nil {
		in, out := &in.CacheSecretFilesSpcMapping, &out.CacheSecretFilesSpcMapping
		*out = make(map[string]*CacheSpcNodeRefMap, len(*in))
		for key, val := range *in {
			var outVal *CacheSpcNodeRefMap
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(CacheSpcNodeRefMap)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
	...
	if in.PodsName != nil {
		in, out := &in.PodsName, &out.PodsName
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheSpcNodeRefMap) DeepCopyInto(out *CacheSpcNodeRefMap) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheSpcNodeRefMap.
func (in *CacheSpcNodeRefMap) DeepCopy() *CacheSpcNodeRefMap {
	if in == nil {
		return nil
	}
	out := new(CacheSpcNodeRefMap)
...
func (in *SecretProviderCacheSpec) DeepCopyInto(out *SecretProviderCacheSpec) {
	*out = *in
	if in.WorkloadSecretsMap != nil {
		in, out := &in.WorkloadSecretsMap, &out.WorkloadSecretsMap
