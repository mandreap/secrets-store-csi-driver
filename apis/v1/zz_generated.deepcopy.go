...
func (in *CacheAuthorizationInformation) DeepCopyInto(out *CacheAuthorizationInformation) {
	*out = *in
	if in.ServiceAccountData != nil {
		in, out := &in.ServiceAccountData, &out.ServiceAccountData
		*out = make([]*ServiceAccountInformation, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ServiceAccountInformation)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheAuthorizationInformation.
func (in *CacheAuthorizationInformation) DeepCopy() *CacheAuthorizationInformation {
	if in == nil {
		return nil
	}
	out := new(CacheAuthorizationInformation)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheObjectVersions) DeepCopyInto(out *CacheObjectVersions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheObjectVersions.
func (in *CacheObjectVersions) DeepCopy() *CacheObjectVersions {
	if in == nil {
		return nil
	}
	out := new(CacheObjectVersions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CacheSpcWorkloadFiles) DeepCopyInto(out *CacheSpcWorkloadFiles) {
	*out = *in
	if in.FileObjectVersions != nil {
		in, out := &in.FileObjectVersions, &out.FileObjectVersions
		*out = make([]*CacheObjectVersions, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CacheObjectVersions)
...
func (in *SecretProviderCacheSpec) DeepCopyInto(out *SecretProviderCacheSpec) {
	*out = *in
	if in.CacheAuthorizationData != nil {
		in, out := &in.CacheAuthorizationData, &out.CacheAuthorizationData
		*out = new(CacheAuthorizationInformation)
		(*in).DeepCopyInto(*out)
	}
	if in.SpcCacheFilesObjects != nil {
		in, out := &in.SpcCacheFilesObjects, &out.SpcCacheFilesObjects
		*out = new(CacheSpcWorkloadFiles)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceAccountInformation) DeepCopyInto(out *ServiceAccountInformation) {
	*out = *in
	if in.ServiceAccountAudience != nil {
		in, out := &in.ServiceAccountAudience, &out.ServiceAccountAudience
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceAccountInformation.
func (in *ServiceAccountInformation) DeepCopy() *ServiceAccountInformation {
	if in == nil {
		return nil
	}
	out := new(ServiceAccountInformation)
