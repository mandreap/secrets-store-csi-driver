...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SPCaPodSpcSecretsMapping) DeepCopyInto(out *SPCaPodSpcSecretsMapping) {
	*out = *in
	if in.Objects != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SPCaPodSpcSecretsMapping.
func (in *SPCaPodSpcSecretsMapping) DeepCopy() *SPCaPodSpcSecretsMapping {
	if in == nil {
		return nil
	}
	out := new(SPCaPodSpcSecretsMapping)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretProviderCacheStatus) DeepCopyInto(out *SecretProviderCacheStatus) {
	*out = *in
	if in.SPCaPodSpcSecretsMapping != nil {
		in, out := &in.SPCaPodSpcSecretsMapping, &out.SPCaPodSpcSecretsMapping
		*out = make([]*SPCaPodSpcSecretsMapping, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SPCaPodSpcSecretsMapping)
