...
func (in *CacheFile) DeepCopyInto(out *CacheFile) {
	*out = *in
	...
	if in.ObjectVersion != nil {
		...
		*out = make([]*CacheObjectVersion, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CacheObjectVersion)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheObjectVersion) DeepCopyInto(out *CacheObjectVersion) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheObjectVersion.
func (in *CacheObjectVersion) DeepCopy() *CacheObjectVersion {
	if in == nil {
		return nil
	}
	out := new(CacheObjectVersion)
