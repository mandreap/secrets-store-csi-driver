...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CachePodSecrets) DeepCopyInto(out *CachePodSecrets) {
	*out = *in
	if in.CacheSecretsSpcMapping != nil {
		in, out := &in.CacheSecretsSpcMapping, &out.CacheSecretsSpcMapping
		*out = make(map[string]*CacheSecretProviderClassSecrets, len(*in))
		for key, val := range *in {
			var outVal *CacheSecretProviderClassSecrets
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(CacheSecretProviderClassSecrets)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CachePodSecrets.
func (in *CachePodSecrets) DeepCopy() *CachePodSecrets {
	if in == nil {
		return nil
	}
	out := new(CachePodSecrets)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheSecret) DeepCopyInto(out *CacheSecret) {
	*out = *in
	if in.Labels != nil {
	...
	if in.SecretObjectData != nil {
		in, out := &in.SecretObjectData, &out.SecretObjectData
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheSecret.
func (in *CacheSecret) DeepCopy() *CacheSecret {
	if in == nil {
		return nil
	}
	out := new(CacheSecret)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheSecretProviderClassSecrets) DeepCopyInto(out *CacheSecretProviderClassSecrets) {
	*out = *in
	if in.CacheSecretsMap != nil {
		in, out := &in.CacheSecretsMap, &out.CacheSecretsMap
		*out = make(map[string]*CacheSecret, len(*in))
		for key, val := range *in {
			var outVal *CacheSecret
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheSecretProviderClassSecrets.
func (in *CacheSecretProviderClassSecrets) DeepCopy() *CacheSecretProviderClassSecrets {
	if in == nil {
		return nil
	}
	out := new(CacheSecretProviderClassSecrets)
...
func (in *SecretProviderCacheSpec) DeepCopyInto(out *SecretProviderCacheSpec) {
	*out = *in
	if in.PodSecretsMap != nil {
		in, out := &in.PodSecretsMap, &out.PodSecretsMap
		*out = make(map[string]*CachePodSecrets, len(*in))
		for key, val := range *in {
			var outVal *CachePodSecrets
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
