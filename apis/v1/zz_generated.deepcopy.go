...
func (in *CachePodSecrets) DeepCopyInto(out *CachePodSecrets) {
	*out = *in
	if in.CacheSecretsSpcMapping != nil {
		...
		*out = make([]*CacheSecretProviderClassSecrets, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *CacheSecretProviderClassSecrets) DeepCopyInto(out *CacheSecretProviderClassSecrets) {
	*out = *in
	if in.CacheSecrets != nil {
		in, out := &in.CacheSecrets, &out.CacheSecrets
		*out = make([]*CacheSecret, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CacheSecret)
...
func (in *SecretProviderCacheStatus) DeepCopyInto(out *SecretProviderCacheStatus) {
	*out = *in
	if in.PodSecrets != nil {
		in, out := &in.PodSecrets, &out.PodSecrets
		*out = make([]*CachePodSecrets, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CachePodSecrets)
