...
const (
	CSIDriverProvider_Version_FullMethodName           = "/v1alpha1.CSIDriverProvider/Version"
	CSIDriverProvider_Mount_FullMethodName             = "/v1alpha1.CSIDriverProvider/Mount"
	CSIDriverProvider_SetSimulationMode_FullMethodName = "/v1alpha1.CSIDriverProvider/SetSimulationMode"
	CSIDriverProvider_GetSimulationMode_FullMethodName = "/v1alpha1.CSIDriverProvider/GetSimulationMode"
)
...
type CSIDriverProviderClient interface {
	...
	// Set simultaion mode
	SetSimulationMode(ctx context.Context, in *BoolValue, opts ...grpc.CallOption) (*Void, error)
	// Get simulation mode
	GetSimulationMode(ctx context.Context, in *Void, opts ...grpc.CallOption) (*BoolValue, error)
}
...
func (c *cSIDriverProviderClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, CSIDriverProvider_Version_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cSIDriverProviderClient) Mount(ctx context.Context, in *MountRequest, opts ...grpc.CallOption) (*MountResponse, error) {
	...
	err := c.cc.Invoke(ctx, CSIDriverProvider_Mount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cSIDriverProviderClient) SetSimulationMode(ctx context.Context, in *BoolValue, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CSIDriverProvider_SetSimulationMode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cSIDriverProviderClient) GetSimulationMode(ctx context.Context, in *Void, opts ...grpc.CallOption) (*BoolValue, error) {
	out := new(BoolValue)
	err := c.cc.Invoke(ctx, CSIDriverProvider_GetSimulationMode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CSIDriverProviderServer interface {
	...
	// Set simultaion mode
	SetSimulationMode(context.Context, *BoolValue) (*Void, error)
	// Get simulation mode
	GetSimulationMode(context.Context, *Void) (*BoolValue, error)
}
...
func (UnimplementedCSIDriverProviderServer) SetSimulationMode(context.Context, *BoolValue) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetSimulationMode not implemented")
}
func (UnimplementedCSIDriverProviderServer) GetSimulationMode(context.Context, *Void) (*BoolValue, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSimulationMode not implemented")
}
...
func _CSIDriverProvider_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CSIDriverProvider_Version_FullMethodName,
	}
...
func _CSIDriverProvider_Mount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CSIDriverProvider_Mount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CSIDriverProvider_SetSimulationMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BoolValue)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CSIDriverProviderServer).SetSimulationMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CSIDriverProvider_SetSimulationMode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CSIDriverProviderServer).SetSimulationMode(ctx, req.(*BoolValue))
	}
	return interceptor(ctx, in, info, handler)
}

func _CSIDriverProvider_GetSimulationMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CSIDriverProviderServer).GetSimulationMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CSIDriverProvider_GetSimulationMode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CSIDriverProviderServer).GetSimulationMode(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CSIDriverProvider_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetSimulationMode",
			Handler:    _CSIDriverProvider_SetSimulationMode_Handler,
		},
		{
			MethodName: "GetSimulationMode",
			Handler:    _CSIDriverProvider_GetSimulationMode_Handler,
		},
	},
